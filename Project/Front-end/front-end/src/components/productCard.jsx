    ...
    return (
        <div className="group w-full max-w-[300px] bg-white rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-1 flex flex-col overflow-hidden border border-secondary/5 m-3">
            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <button className="w-full py-2.5 rounded-xl font-medium tracking-wide bg-primary/50 text-secondary border border-primary hover:bg-accent hover:text-white hover:border-accent transition-all duration-300 active:scale-[0.98]">
                    View Product
                </button>
